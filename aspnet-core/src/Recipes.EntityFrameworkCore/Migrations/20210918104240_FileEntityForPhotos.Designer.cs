...
namespace Recipes.Migrations
{
    ...
    [Migration("20210918104240_FileEntityForPhotos")]
    partial class FileEntityForPhotos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recipes.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Recipes.Recipes.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("ForAmount")
                        .HasColumnType("int")
                        .HasColumnName("ForAmount");

                    b.Property<string>("ForUnit")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("ForUnit");
            ...
            modelBuilder.Entity("Recipes.Recipes.RecipeIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Recipes.Recipes.RecipeStep", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Recipes.Categories.Category", b =>
                {
                    b.OwnsOne("Recipes.Files.File", "Photo", b1 =>
                        {
            ...
            modelBuilder.Entity("Recipes.Recipes.Recipe", b =>
                {
                    b.HasOne("Recipes.Categories.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
            ...
            modelBuilder.Entity("Recipes.Recipes.RecipeIngredient", b =>
                {
                    b.HasOne("Recipes.Recipes.Recipe", "Recipe")
